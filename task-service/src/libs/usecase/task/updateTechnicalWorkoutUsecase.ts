import { TechnicalWorkout } from "../../entities/updateTechnicalWorkout";

export const updateTechnicalWorkout_Usecase = (dependencies: any) => {
  const {
  ...
  const executeFunction = async (data: any) => {
    try {
      ...
      const technicalWorkout = new TechnicalWorkout(data);
      console.log(technicalWorkout, "personal workout dataa");
      
      const response = await taskRepository.updateTechnicalWorkout(technicalWorkout);
