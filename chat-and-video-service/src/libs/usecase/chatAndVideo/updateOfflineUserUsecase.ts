...
export const updateOfflineUser_Usecase = async (chaterId:string) => {
    ...
    if (!chatAndVideoRepository) {
        ...
        try {
            ...
            const getOnlineUsers = await chatAndVideoRepository.updateOfflineUser(chaterId);
...
export default updateOfflineUser_Usecase